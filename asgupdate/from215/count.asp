...
' * @version         SVN: $Id: count.asp 116 2008-04-22 18:27:35Z weppos $
' */
...
Sub Log()	
	...
	'-----------------------------------------------------------------------------------------
		...
		objClassI.Options.Guessing = false
		objClassI.Options.workAgentdetails = false
		...
		strAsgBrowser = 			objClassI("Agent")
		strAsgBrowserLang = 		objClassI("Agent.Language")
